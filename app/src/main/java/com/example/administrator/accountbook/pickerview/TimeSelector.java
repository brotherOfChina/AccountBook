package com.example.administrator.accountbook.pickerview;
...
public class TimeSelector {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.pop_select_date);
    ...
    private void initView() {
        ...
        tv_select = (TextView) seletorDialog.findViewById(R.id.tv_sure);
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context,DateUtil.format(selectedCalender.getTime(),FORMAT_STR),Toast.LENGTH_SHORT);
                seletorDialog.dismiss();
            }
        });
