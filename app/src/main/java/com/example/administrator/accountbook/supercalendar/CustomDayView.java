...
//                dateTv.setBackgroundColor(context.getResources().getColor(R.color.white));
            } else {
...
//                dateTv.setBackgroundColor(context.getResources().getColor(R.color.white));
                if (Utils.loadMarkData().get(date.toString()).equals("0")) {
                    marker.setImageResource(R.drawable.bg_date_blue);
                    marker.setEnabled(true);
                } else {
                    marker.setImageResource(R.drawable.bg_date);
